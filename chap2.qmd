...
-   **Test statistic**
    -   **Log-transformed and normalized** $$
        ...
        $$
        -   $n = N_1 + N_0$
        -   $\hat{\rm SE}$: standard error of numerator by $U$-statistic method [@Luo2015; @Bebu2016; @dong2016]
    -   **Null hypothesis** $$
...
-   **More on sample size**
    -   Simplified/approximate approaches in various scenarios [@yu2022; @wang2023a; @gasparyan2021; @zhou2022; @seifu2022, etc.]
