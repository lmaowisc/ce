...
title-slide-attributes:
  data-background-image: sj_images/standford.png
  data-background-size: 30%
  data-background-position: 2% 4%
---
...
- **Methodological research**
    - Clinical trials, causal inference, machine learning 
      - NIH R01HL149875 and NSF DMS2015526 grants
      - Software development (R packages, Shiny apps, etc.)
- **Collaborative leadership**
    - UW Carbone Cancer Center 
      – Biostatistics Shared Resource
    - NCI-Sponsored Clinical Trials Network
...
<!-- Courses -->
<!--  Applied Survival Analysis (BMI/STAT 741; 2020—2026) -->
<!--  Short courses in advanced methodology and R programming -->
<!--  Mentoring -->
<!--  3 current + 4 former PhD students (→ JP Morgan, Amazon, Eli Lilly, Merck) -->

- **Courses**
    - Applied Survival Analysis (BMI/STAT 741; 2020—2026)
    - Short courses in advanced methodology and R programming
    - A textbook on survival analysis (in print by Springer)

- **Mentoring**
    - 2 current + 1 graduating + 4 former PhD students (→ JP Morgan, Amazon, Eli Lilly, Merck)
    - Research staff, research assistants, etc.        

## Service and Leadership

<!-- Co-Editor | Journal of Biopharmaceutical Statistics | 04/2026 – Now -->
<!-- Associate Editor | Biometric Bulletin | 12/2025 – Now -->
<!-- Associate Editor | Statistics in Biopharmaceutical Research | 01/2023 – Now -->
<!-- Statistical Editor | JACC Journals | 12/2022 – Now -->


- **Journal editorial**
    - **Co-Editor** | *Journal of Biopharmaceutical Statistics* | 04/2026 – Now
    - **Associate Editor** | *Biometrics* | 7/2026 – Now
    - **Associate Editor** | *Biometric Bulletin* | 12/2025 – Now
    - **Associate Editor** | *Statistics in Biopharmaceutical Research* | 01/2023 – Now
    - **Statistical Editor** | *JACC Journals* | 12/2022 – Now

- **Other**
    - **Program Chair** | 2026 ASA LiDS | 2025 – 2027
    - **NIH-NHLBI**/**PCOR**/**NSF**  study sections/review panels

<!-- ## Research identity -->

<!-- - My work sits at the interface of **collaborative science** and **methodological development** -->

<!-- - Collaborations motivate new statistical questions   -->
<!--   Complex endpoints, longitudinal outcomes, pragmatic studies, real-world data -->

<!-- - Methods return to practice through   -->
<!--   Trial design, reproducible workflows, software, and team-based biostatistics -->

<!-- - At QSU, I hope to build on this model:   -->
<!--   **methods → tools → collaboration → impact** -->
...
::: {style="font-size: 0.75em; line-height: 1.2em;"}
...
- **GPC within stratum** $\to$ combine [@dong2017; @gasparyan2020; @dong2023] ![](sj_images/str_winloss.png){width="100%" fig-align="center"} \begin{align}
...
- **Notation**
  ...
  - WR $=\hat w_{1, 0} / \hat w_{0, 1}$; $\,\,$ NB $=\hat w_{1, 0} - \hat w_{0, 1}$; $\,\,$ WO $=(1 + \text{NB}) / (1 - \text{NB})$

## Binary Case Equivalencies

- **Binary outcome, no censoring**
  - $Y^\a_i = 1$ (response) vs 0 (no-response) for subject $i$ in group $a$ ($a = 0, 1$)
...
- **Comparison rules**
  - Death $\to$ Number of events $\to$ Time to first/last event [@mao2022a] $\to$ ... (Biomarker/QoL changes)
...
::: {style="font-size: 0.75em; line-height: 1.2em;"}
@gregson:2025 summarizes recent/ongoing RCTs: <br>
:::
...
- **Rank-based approximation** [@yu2022]
  ...
  - $\log(\text{WR})$ and $p_{\text{tie}}$ elicitable from component-wise win-loss measures [@barnhart:2025:sim; @barnhart:2025:sbr]
...
- **Without censoring**
  ...
  - Change with follow-up time [@oakes2016; @mao2024] ![](images/exmp.png){fig-align="center" width="75%"}
- **With censoring**
...
- **A proportional win-fractions (PW) model**
  ...
  - Elastic net regularization for high-dimensional $Z$ [@mao2025, R tool [`WRNet`](https://lmaowisc.github.io/wrnet/){target="_blank"}]
